...
> [!IMPORTANT]  
> This repository's master branch hosts the TON Indexer designed for direct interaction with the TON Node database. If you are looking for indexer that operates through `tonlib + liteserver`, please refer to the branch (legacy)[/toncenter/ton-indexer/legacy].
